...
// ── CONSTANTS ──────────────────────────────────────────────────────────────
const PROS = [
  // 2026 U.S. Open field — Shinnecock Hills (auto-syncs to ESPN live leaderboard by name)
  {id:'p1', name:'Scottie Scheffler'},  {id:'p2', name:'Rory McIlroy'},
  {id:'p3', name:'J.J. Spaun'},  {id:'p4', name:'Bryson DeChambeau'},
  {id:'p5', name:'Jon Rahm'},  {id:'p6', name:'Xander Schauffele'},
  {id:'p7', name:'Matt Fitzpatrick'},  {id:'p8', name:'Justin Thomas'},
  {id:'p9', name:'Collin Morikawa'},  {id:'p10', name:'Brooks Koepka'},
  {id:'p11', name:'Wyndham Clark'},  {id:'p12', name:'Gary Woodland'},
  {id:'p13', name:'Dustin Johnson'},  {id:'p14', name:'Aaron Rai'},
  {id:'p15', name:'Brian Harman'},  {id:'p16', name:'Cameron Smith'},
  {id:'p17', name:'Jordan Spieth'},  {id:'p18', name:'Ludvig Aberg'},
  {id:'p19', name:'Akshay Bhatia'},  {id:'p20', name:'Keegan Bradley'},
  {id:'p21', name:'Jacob Bridgeman'},  {id:'p22', name:'Sam Burns'},
  {id:'p23', name:'Patrick Cantlay'},  {id:'p24', name:'Corey Conners'},
  {id:'p25', name:'Harris English'},  {id:'p26', name:'Tommy Fleetwood'},
  {id:'p27', name:'Chris Gotterup'},  {id:'p28', name:'Ben Griffin'},
  {id:'p29', name:'Harry Hall'},  {id:'p30', name:'Russell Henley'},
  {id:'p31', name:'Viktor Hovland'},  {id:'p32', name:'Sungjae Im'},
  {id:'p33', name:'Shane Lowry'},  {id:'p34', name:'Robert MacIntyre'},
  {id:'p35', name:'Hideki Matsuyama'},  {id:'p36', name:'Maverick McNealy'},
  {id:'p37', name:'Andrew Novak'},  {id:'p38', name:'Justin Rose'},
  {id:'p39', name:'Sepp Straka'},  {id:'p40', name:'Nick Taylor'},
  {id:'p41', name:'Cameron Young'},  {id:'p42', name:'Patrick Reed'},
  {id:'p43', name:'Tyrrell Hatton'},  {id:'p44', name:'Carlos Ortiz'},
  {id:'p45', name:'Alex Noren'},  {id:'p46', name:'Rickie Fowler'},
  {id:'p47', name:'Min Woo Lee'},  {id:'p48', name:'Si Woo Kim'},
  {id:'p49', name:'Tom Kim'},  {id:'p50', name:'Adam Scott'},
  {id:'p51', name:'Jason Day'},  {id:'p52', name:'Max Homa'},
  {id:'p53', name:'Taylor Pendrith'},  {id:'p54', name:'Sahith Theegala'},
  {id:'p55', name:'Denny McCarthy'},  {id:'p56', name:'Davis Thompson'},
  {id:'p57', name:'Stephan Jaeger'},  {id:'p58', name:'Rasmus Hojgaard'},
  {id:'p59', name:'Nicolai Hojgaard'},  {id:'p60', name:'Thomas Detry'},
  {id:'p61', name:'Matthieu Pavon'},  {id:'p62', name:'J.T. Poston'},
  {id:'p63', name:'Kurt Kitayama'},  {id:'p64', name:'Byeong Hun An'},
  {id:'p65', name:'Lucas Glover'},  {id:'p66', name:'Eric Cole'},
  {id:'p67', name:'Jhonattan Vegas'},  {id:'p68', name:'Joaquin Niemann'},
  {id:'p69', name:'Padraig Harrington'},  {id:'p70', name:'Johnny Keefer'},
  {id:'p71', name:'Jake Knapp'},  {id:'p72', name:'Ryan Gerard'},
  {id:'p73', name:'Kristoffer Reitan'},  {id:'p74', name:'Daniel Berger'},
  {id:'p75', name:'Michael Kim'},  {id:'p76', name:'Matt McCarty'},
  {id:'p77', name:'Nicolas Echavarria'},  {id:'p78', name:'Samuel Stevens'},
  {id:'p79', name:'Ryan Fox'},  {id:'p80', name:'Michael Brennan'},
  {id:'p81', name:'Pierceson Coody'},  {id:'p82', name:'David Puig'},
  {id:'p83', name:'Ryo Hisatsune'},  {id:'p84', name:'Bud Cauley'},
  {id:'p85', name:'Alex Smalley'},  {id:'p86', name:'James Nicholas'},
  {id:'p87', name:'Taylor Montgomery'},  {id:'p88', name:'Caleb Surratt'},
  {id:'p89', name:'Chandler Phillips'},  {id:'p90', name:'Harry Higgs'},
  {id:'p91', name:'Jayden Schaper'},  {id:'p92', name:'Jackson Suber'},
  {id:'p93', name:'Alejandro Tosti'},  {id:'p94', name:'Matthew Jordan'},
  {id:'p95', name:'Nathan Kimsey'},  {id:'p96', name:'Cooper Dossey'},
  {id:'p97', name:'Carl Yuan'},  {id:'p98', name:'Brandon Wu'},
  {id:'p99', name:'Jimmy Stanger'},  {id:'p100', name:'William Mouw'},
  {id:'p101', name:'Hennie du Plessis'},  {id:'p102', name:'Adrien Saddier'},
  {id:'p103', name:'Jackson Van Paris'},  {id:'p104', name:'Ugo Coussaud'},
  {id:'p105', name:'Neal Shipley'},  {id:'p106', name:'Matti Schmid'},
  {id:'p107', name:'Zac Blair'},  {id:'p108', name:'Kevin Roy'},
  {id:'p109', name:'Niklas Norgaard'},  {id:'p110', name:'Rocco Repetto Taylor'},
  {id:'p111', name:'Sudarshan Yellamaraju'},  {id:'p112', name:'Laurie Canter'},
  {id:'p113', name:'John Parry'},  {id:'p114', name:'Chris Kirk'},
  {id:'p115', name:'Max McGreevy'},  {id:'p116', name:'Andrew Putnam'},
  {id:'p117', name:'Filippo Celli'},  {id:'p118', name:'Adrien Dumont de Chassart'},
  {id:'p119', name:'Lucas Herbert'},  {id:'p120', name:'Angel Hidalgo'},
  {id:'p121', name:'Cole Hammer'},  {id:'p122', name:'Nick Hardy'},
  {id:'p123', name:'Robbie Higgins'},  {id:'p124', name:'J.B. Holmes'},
  {id:'p125', name:'Billy Horschel'},  {id:'p126', name:'Ben James'},
  {id:'p127', name:'Tom McKibbin'},  {id:'p128', name:'Max Greyserman'},
  {id:'p129', name:'Aldrich Potgieter'},  {id:'p130', name:'Arni Sveinsson'},
  {id:'p131', name:'Mason Howell (a)'},  {id:'p132', name:'Hamilton Coleman (a)'},
  {id:'p133', name:'Brandon Holtz (a)'},  {id:'p134', name:'Jackson Herrington (a)'},
  {id:'p135', name:'Ethan Fang (a)'},  {id:'p136', name:'Jackson Koivun (a)'},
  {id:'p137', name:'Mateo Pulcini (a)'},  {id:'p138', name:'Vaughn Harber (a)'},
  ...
  return (
    <div className="page">
      ...
      <div className="tabs">
        ...
        <button className={`tab ${tab==='field'?'on':''}`} onClick={()=>setTab('field')}>Leaderboard</button>
      </div>
