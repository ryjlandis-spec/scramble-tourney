...
const PROS = [
  ...
  {id:'p17',name:'Jordan Spieth'},
  // ── Top contenders / Tour Championship qualifiers ──
  {id:'p18',name:'Ludvig Aberg'},         {id:'p19',name:'Akshay Bhatia'},
  {id:'p20',name:'Keegan Bradley'},       {id:'p21',name:'Jacob Bridgeman'},
  {id:'p22',name:'Sam Burns'},            {id:'p23',name:'Patrick Cantlay'},
  {id:'p24',name:'Corey Conners'},        {id:'p25',name:'Harris English'},
  {id:'p26',name:'Tommy Fleetwood'},      {id:'p27',name:'Chris Gotterup'},
  {id:'p28',name:'Ben Griffin'},          {id:'p29',name:'Harry Hall'},
  {id:'p30',name:'Russell Henley'},       {id:'p31',name:'Viktor Hovland'},
  {id:'p32',name:'Sungjae Im'},           {id:'p33',name:'Shane Lowry'},
  {id:'p34',name:'Robert MacIntyre'},     {id:'p35',name:'Hideki Matsuyama'},
  {id:'p36',name:'Maverick McNealy'},     {id:'p37',name:'Andrew Novak'},
  {id:'p38',name:'Justin Rose'},          {id:'p39',name:'Sepp Straka'},
  {id:'p40',name:'Nick Taylor'},          {id:'p41',name:'Cameron Young'},
  {id:'p42',name:'Patrick Reed'},         {id:'p43',name:'Tyrrell Hatton'},
  {id:'p44',name:'Carlos Ortiz'},         {id:'p45',name:'Alex Noren'},
  // ── Other confirmed field members ──
  {id:'p46',name:'Rickie Fowler'},        {id:'p47',name:'Min Woo Lee'},
  {id:'p48',name:'Si Woo Kim'},           {id:'p49',name:'Tom Kim'},
  {id:'p50',name:'Adam Scott'},           {id:'p51',name:'Jason Day'},
  {id:'p52',name:'Max Homa'},             {id:'p53',name:'Taylor Pendrith'},
  {id:'p54',name:'Sahith Theegala'},      {id:'p55',name:'Denny McCarthy'},
  {id:'p56',name:'Davis Thompson'},       {id:'p57',name:'Stephan Jaeger'},
  {id:'p58',name:'Rasmus Hojgaard'},      {id:'p59',name:'Nicolai Hojgaard'},
  {id:'p60',name:'Thomas Detry'},         {id:'p61',name:'Matthieu Pavon'},
  {id:'p62',name:'J.T. Poston'},          {id:'p63',name:'Kurt Kitayama'},
  {id:'p64',name:'Byeong Hun An'},        {id:'p65',name:'Lucas Glover'},
  {id:'p66',name:'Eric Cole'},            {id:'p67',name:'Jhonattan Vegas'},
  {id:'p68',name:'Joaquin Niemann'},      {id:'p69',name:'Padraig Harrington'},
  {id:'p70',name:'Johnny Keefer'},        {id:'p71',name:'Jake Knapp'},
  {id:'p72',name:'Ryan Gerard'},          {id:'p73',name:'Kristoffer Reitan'},
  {id:'p74',name:'Daniel Berger'},        {id:'p75',name:'Michael Kim'},
  {id:'p76',name:'Matt McCarty'},         {id:'p77',name:'Nicolas Echavarria'},
  {id:'p78',name:'Samuel Stevens'},       {id:'p79',name:'Ryan Fox'},
  {id:'p80',name:'Michael Brennan'},      {id:'p81',name:'Pierceson Coody'},
  {id:'p82',name:'David Puig'},           {id:'p83',name:'Ryo Hisatsune'},
  {id:'p84',name:'Bud Cauley'},           {id:'p85',name:'Alex Smalley'},
  // ── Amateurs ──
